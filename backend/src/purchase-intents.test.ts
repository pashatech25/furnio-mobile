...
function environment(): Env {
  return {
    ...
    REVENUECAT_SECRET_API_KEY: "fixture-revenuecat-private-key-only",
    REVENUECAT_WEBHOOK_AUTHORIZATION: "fixture-webhook-authorization-only-32",
    REVENUECAT_WEBHOOK_SIGNING_SECRET: "fixture-webhook-signing-secret-only-32",
