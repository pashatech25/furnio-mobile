...
export function ReferencePreview() {
  ...
  return <View pointerEvents="none" style={StyleSheet.absoluteFill}>
    <Image source={require("../assets/service-previews/reference-before.jpg")} resizeMode="cover" style={styles.room} />
    ...
    <Animated.Image source={require("../assets/service-previews/reference-after.jpg")} resizeMode="cover" style={[styles.room,{opacity:interpolate([0,46,62,100],[0,0,1,1])}]} />
  </View>;
}

// RN supplies a bundled image's intrinsic pixel dimensions unless explicitly
// overridden. Insets alone left the 960px room cropped inside a ~180px card.
